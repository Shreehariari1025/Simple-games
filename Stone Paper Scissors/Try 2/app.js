...
const genCompChoice = () => {
    ...
    if (options[ranIdx] === "Stone"){
        document.getElementById("Stone1").style.backgroundColor = "#003";
    }
    else if( options[ranIdx] === "Paper"){
        document.getElementById("Paper1").style.backgroundColor = "#003";
    }
    else{
        document.getElementById("Scissors1").style.backgroundColor = "#003";
...
choices.forEach((choice) => {
    choice.addEventListener("click",() => {
        ...
        document.getElementById("Stone1").style.backgroundColor = "white";
        document.getElementById("Paper1").style.backgroundColor = "white";
        document.getElementById("Scissors1").style.backgroundColor = "white";
